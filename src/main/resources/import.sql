INSERT INTO "user" (username, name, password, role) values ('lmarquez', 'luis márquez', '$2a$10$H4cyFCD8E2VL.iUrIY703.aNCauKAGehV5502LARWcuJeyINdwOEa', 'CUSTOMER');
INSERT INTO "user" (username, name, password, role) values ('mhernandez', 'menganito hernández', '$2a$10$nHO5QRbQdtJ5iCWmSPZHSeI2v36i2vuT3Nm/Wxiexj4LqPOOH8tK.', 'ADMINISTRATOR');
