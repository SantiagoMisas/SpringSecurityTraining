...
import com.jjwte.SpringSecurityTraining.services.JwtAuthenticationFilter;
import com.jjwte.SpringSecurityTraining.utilities.Permission;
...
public class HttpSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(crsfConfig->crsfConfig.disable())
